...
const getIconClass = (item) => {
  ...
  const iconMap = {
    ...
    'css5': 'devicon-css3-plain colored',
      ...
      >
        {items.map((item, index) => {
          ...
          return (
            ...
            >
              <div className={`flex items-center gap-3 p-4 bg-[#111] rounded-lg ${selectedIndex === index ? 'bg-[#222]' : ''} ${itemClassName}`}>
                {iconClass && <i className={`${iconClass} text-2xl`}></i>}
